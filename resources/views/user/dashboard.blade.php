            ...
            <div class="bg-white rounded-xl shadow-sm p-6 mb-8">
                ...
                <div class="grid grid-cols-7 gap-4">
                    @foreach ($weekTasks as $day)
                        <a href="{{ route('user.dashboard', ['date' => $day['date']->format('Y-m-d')]) }}"
                        ...
                        @foreach ($selectedDateTasks as $task)
                            <div
                                ...
                                <div class="flex gap-2">
                                    ...
                                    @else
                                        <button class="p-2 opacity-50 cursor-not-allowed" disabled
                                            title="Tidak dapat edit task yang sudah diproses">
                                    ...
                                    @elseif($task->status == 'Dalam Proses')
                                        <button class="p-2 opacity-50 cursor-not-allowed" disabled
                                            title="Task yang sudah di-approve tidak dapat dihapus">
                                            <svg class="w-5 h-5 text-gray-400" fill="none" stroke="currentColor"
                                                viewBox="0 0 24 24">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                    ...
                                    @elseif($task->status == 'Selesai')
                                        <button class="p-2 opacity-50 cursor-not-allowed" disabled
                                            title="Task yang sudah selesai tidak dapat dihapus">
                                            <svg class="w-5 h-5 text-gray-400" fill="none" stroke="currentColor"
                                                viewBox="0 0 24 24">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                                    d="M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z" />
