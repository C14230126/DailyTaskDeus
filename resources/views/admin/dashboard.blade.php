    ...
    <div class="min-h-screen bg-gray-50">
        ...
        <aside class="fixed left-0 top-0 h-full w-64 bg-white shadow-lg">
            <div class="p-6">
                ...
                <div class="mb-4 px-4 py-2 bg-blue-50 rounded-lg">
                    <p class="text-xs text-blue-600 font-semibold">ADMIN PANEL</p>
                </div>
        ...
        <div class="ml-64 p-8">
            ...
            <div class="flex justify-between items-center mb-8">
                <div>
                    ...
                    <p class="text-gray-600 text-sm">{{ now()->locale('id')->isoFormat('dddd, D MMMM YYYY') }} | Admin Panel
                    </p>
                </div>
